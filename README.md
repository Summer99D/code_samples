...
There are three sub-folders in this repository: Python coding samples in Visual Studio(data analysis and ML) R coding samples in R-studio(data analysis and ML) and data visualization from both!
...
Python folder full project address: 
